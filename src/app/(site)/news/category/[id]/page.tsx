...
const ConenctorDetails = () => {
  ...
  async function getData() {
    setIsLoading(true)
    try {
      const result = await BlogCategoryService.getDetails(String(pathname?.id));
  ...
  async function submitForm(e: React.FormEvent<HTMLFormElement>) {
    ...
    setIsLoading(true);
    try {
      const result = await BlogCategoryService.updateCategory(String(pathname?.id), data);
      if (result?.data?.success) {
...
export default ConenctorDetails;
