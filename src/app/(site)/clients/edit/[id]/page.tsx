  ...
  async function submitForm(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result?.data?.success) {
        ...
        toast.error(result?.data?.message ?? "There was a problem trying to create the client. Please check all fields!");
      }
    } catch (err: any) {
      toast.error(err?.response?.data?.message ?? "There was a problem trying to create the client. Please check all fields!");
    } finally {
      setLoading(false);
    }
  }
